...
Placeholders are rewritten into runtime expressions that __always return type__ `text`. This is why they may need to be explicitly cast (i.e. `__FROM__::integer, __TO__::integer` in the example below).  
